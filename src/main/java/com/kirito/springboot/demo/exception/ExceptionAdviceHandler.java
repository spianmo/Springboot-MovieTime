...
public final class ExceptionAdviceHandler {
    ...
    public BaseResponse<String> unKnowExceptionHandler(Exception e) {
        ...
        return new BaseResponse<>(HttpStatusCode.UNKNOW_EXCEPTION.getStatus(), message);
    }
    ...
    public BaseResponse<String> runtimeExceptionHandler(RuntimeException e) {
        ...
        return new BaseResponse<>(HttpStatusCode.RUNTIME_EXCEPTION.getStatus(), message);
    }
    ...
    public BaseResponse<String> nullPointerExceptionHandler(NullPointerException e) {
        ...
        return new BaseResponse<>(HttpStatusCode.NULL_POINTER_EXCEPTION.getStatus(), message);
    }
    ...
    public BaseResponse<String> abnormalLoginException(AbnormalLoginException e) {
        ...
        return new BaseResponse<>(HttpStatusCode.AUTHENTICATION_EXCEPTION.getStatus(), message);
    }
    ...
    public BaseResponse<String> missingParamException(MissingParamException e) {
        e.printStackTrace();
        return new BaseResponse<>(HttpStatusCode.MISSING_SERVLET_REQUEST_PARAMETER_EXCEPTION.getStatus(), e.getMessage());
    }

    @ExceptionHandler({InsufficAuthException.class})
    public BaseResponse<String> insufficAuthException(InsufficAuthException e) {
        e.printStackTrace();
        return new BaseResponse<>(HttpStatusCode.AUTHENTICATION_EXCEPTION.getStatus(), e.getMessage());
    }
    ...
    public BaseResponse<String> classCastExceptionHandler(ClassCastException e) {
        ...
        return new BaseResponse<>(HttpStatusCode.CLASS_CAST_EXCEPTION.getStatus(), message);
    }
    ...
    public BaseResponse<String> iOExceptionHandler(IOException e) {
        ...
        return new BaseResponse<>(HttpStatusCode.IO_EXCEPTION.getStatus(), message);
    }
    ...
    public BaseResponse<String> indexOutOfBoundsExceptionHandler(IndexOutOfBoundsException e) {
        ...
        return new BaseResponse<>(HttpStatusCode.INDEX_OUTOF_BOUNDS_EXCEPTION.getStatus(), message);
    }
    ...
    public BaseResponse<String> requestTypeMismatch(MethodArgumentTypeMismatchException e) {
        return new BaseResponse<>(HttpStatusCode.METHOD_ARGUMENT_TYPE_MISMATCH_EXCEPTIION.getStatus(), "参数类型不匹配，参数" + e.getName() + "" + e.getRequiredType());
    }
    ...
    public BaseResponse<String> requestMissingServletRequest(MissingServletRequestParameterException e) {
        return new BaseResponse<>(HttpStatusCode.MISSING_SERVLET_REQUEST_PARAMETER_EXCEPTION.getStatus(), "缺少必要参数，参数名称为" + e.getParameterName());
    }
    ...
    public BaseResponse<String> requestMissingServletRequest(HttpRequestMethodNotSupportedException e) {
        return new BaseResponse<>(HttpStatusCode.HTTP_REQUEST_METHOD_NOT_SUPPORTED_EXCEPTION.getStatus(), "不支持" + e.getMethod() + "方法，支持" + StringUtils.join(e.getSupportedMethods(), ",") + "类型");
    }
    ...
    public BaseResponse<String> httpMessageNotReadableException(HttpMessageNotReadableException e, WebRequest wq) {
        e.printStackTrace();
        return new BaseResponse<>(HttpStatusCode.PARAM_EXCEPTION.getStatus(), "请求参数异常");
    }
    ...
    public BaseResponse<String> methodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        return new BaseResponse<>(HttpStatusCode.PARAM_EXCEPTION.getStatus(), message);
    }

    @ExceptionHandler({NoHandlerFoundException.class})
    public BaseResponse<String> noHandlerFoundException(NoHandlerFoundException e) {
        e.printStackTrace();
        return new BaseResponse<>(HttpStatusCode.NOT_FOUND_EXCEPTION.getStatus(), e.getMessage());
    }

    @ExceptionHandler({ParamRangeException.class})
    public BaseResponse<String> paramOutOfRangeException(ParamRangeException e) {
        e.printStackTrace();
        return new BaseResponse<>(HttpStatusCode.PARAM_EXCEPTION.getStatus(), e.getMessage());
    }
